...
class SiteSetting(models.Model):
    ...
    site_logo = models.ImageField(upload_to='images/site_setting',max_length=200, verbose_name='لوگو سایت')
...
class Slider(models.Model):
    ...
    image = models.ImageField(max_length=200, verbose_name='تصویر اسلایدر')
